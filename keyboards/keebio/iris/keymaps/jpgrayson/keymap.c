...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_LALT,  _______, KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, RSFT_ENT,
                                      KC_LGUI, LOWER,   CAG,       KC_SPC, RAISE,   KC_RALT
  ),
  ...
  _______, _______, _______, _______, _______, _______, _______,  _______, KC_MNXT, KC_MUTE, KC_VOLD, KC_VOLU, KC_MPLY, _______,
